...
interface EditProjectSheetProps {
  ...
  initialTeamMembers: Participant[]
  onUpdated: () => void
}
...
export function EditProjectSheet({
  ...
  const [devpostUrl, setDevpostUrl] = useState(submission.devpost_url)
  ...
  const [prizes, setPrizes] = useState<string[]>(submission.prizes)
  const [prizeInput, setPrizeInput] = useState("")
  const [teamMembers, setTeamMembers] =
    useState<Participant[]>(initialTeamMembers)
  ...
  const isDirty = (() => {
    if (title !== (submission.title || "")) return true
    if (devpostUrl !== submission.devpost_url) return true
    if (repoUrl !== (submission.repo_url || "")) return true
    if (demoUrl !== (submission.demo_url || "")) return true
    if (videoUrl !== (submission.video_url || "")) return true
    if (
      prizes.length !== submission.prizes.length ||
      prizes.some((p, i) => p !== submission.prizes[i])
    )
      return true
    if (teamMembers.length !== initialTeamMembers.length) return true
    const initialIds = new Set(initialTeamMembers.map((m) => m.id))
    if (teamMembers.some((m) => !initialIds.has(m.id))) return true
    return false
  })()
  ...
  const handleSave = async () => {
    ...
    // Sync team members: delete all then re-insert
      ...
      <Sheet open={open} onOpenChange={handleOpenChange}>
        <SheetContent className="overflow-y-auto sm:max-w-2xl">
          <SheetHeader>
            ...
            <SheetDescription>
              Update the project details, prizes, and team members.
            </SheetDescription>
          </SheetHeader>
          ...
          <div className="space-y-6 px-4 pb-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 space-y-2">
                <Label htmlFor="edit-project-devpost">
                  DevPost URL <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="edit-project-devpost"
                  type="url"
                  value={devpostUrl}
              ...
              <div className="col-span-2 space-y-2">
                <Label htmlFor="edit-project-video">Video URL</Label>
                <Input
            ...
            {/* Prizes */}
            <div className="space-y-2">
              <Label htmlFor="edit-project-prizes">Prizes</Label>
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="edit-new-participant-email">
                Email <span className="text-destructive">*</span>
              </Label>
              <Input
                id="edit-new-participant-email"
                type="email"
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-new-participant-first-name">
                First Name
              </Label>
              <Input
                id="edit-new-participant-first-name"
                placeholder="John"
                value={newFirstName}
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-new-participant-last-name">Last Name</Label>
              <Input
                id="edit-new-participant-last-name"
                placeholder="Doe"
                value={newLastName}
